...
public class Reflect {
	...
	public Reflect reflect(String load) {
		try {
			...
			Sys.error("Class [0] can not found in file system.", e, load);
		} catch (NoClassDefFoundError e) {
			Sys.error("Class [0] can not found in file system. " + e.toString(), null, load);
		}
		return this;
	}
	...
	public<type> type call(String function, Object... parameters) {
		try {
			...
			Sys.error("Try to call function [0] with [1] parameters", e, function, length);
			return null;
		}
	}
